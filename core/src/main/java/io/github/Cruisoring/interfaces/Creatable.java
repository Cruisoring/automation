...
/**
 * @see <a href="http://www.artima.com/weblogs/viewpost.jsp?thread=208860">Good article of get generic parameter type.</a>
 */
@FunctionalInterface
public interface Creatable<T extends IUIObject> {
    T create(WorkingContext context, Integer index);

    static HashMap<Class<? extends IUIObject>, Creatable> factories = new HashMap<>();
